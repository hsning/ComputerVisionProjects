...
def main(argv):
    numberOfHiddenNodes = [10, 5, 4, 3, 2, 1, 1/2, 1/3, 1/4, 1/5, 0.15, 1/10]
    ...
    for j in range(len(numberOfHiddenNodes)):
        modelA = MyNetwork().to("cpu")
        modelA.fc1=nn.Linear(in_features=320,out_features=(int)(50*numberOfHiddenNodes[j]))
        modelA.fc2=nn.Linear(in_features=(int)(50*numberOfHiddenNodes[j]),out_features=10)
        print("Increase # of hidden nodes by a scale of: "+str(numberOfHiddenNodes[j]))
